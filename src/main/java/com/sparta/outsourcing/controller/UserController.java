...
public class UserController {
    ...
    * @Valid로 requestdto 유효성 검사, @RequestBody로 http 요청으로 받는 json을 request 객체로 변환
    ...
    public ResponseEntity<String> login(@Valid @RequestBody LoginRequestDto loginRequestDto,
        ...
        // USER_AUTH라는 이름으로 authentication 객체를 세션에 저장
    ...
    @PostMapping("/logout")
    public ResponseEntity<String> logout(HttpServletRequest request) {  // HttpServletRequest : 현재 사용 중이 세션 가져오기 위함
